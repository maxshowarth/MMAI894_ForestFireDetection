...
bucket_files = ['training_sets/rotation_augmentation/rotation_augmentation_train_x_aug.npy', 'training_sets/rotation_augmentation/rotation_augmentation_train_y_aug.npy']
